...
import sys   # using for exit from the program
import pygame
...
GAME_SPRITES = {}
GAME_SOUNDS= {}
PLAYER = 'GALLERY/IMAGES/redbird-midflap.png'
BACKGROUND = 'GALLERY/IMAGES/background-day.png'
PIPE = 'GALLERY/IMAGES/pipe-green.png'
...
if __name__ == "__main__":
    pygame.init() #intialization pygame
    FPSCLOCK = pygame.time.Clock() 
    pygame.display.set_caption('Flappy Bird By Sura kaushik')
    GAME_SPRITES['numbers'] = (     #dictionary
